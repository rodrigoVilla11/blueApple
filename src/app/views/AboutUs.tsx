...
const AboutUs = () => {
  return (
    <div className=" w-full flex flex-col justify-center items-center bg-gradient-blueApple text-sm pt-4 sm:p-20" id="aboutUs">
      <h2 className="text-3xl">Sobre Nosotros</h2>
      <div className="flex flex-col sm:flex-row justify-center items-center p-4 sm:p-10">
        <Image
          alt="first-pic"
          src="/first-pic.jpg"
          width={462}
